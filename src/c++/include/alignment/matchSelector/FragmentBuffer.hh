...
public:
    ...
    FragmentBuffer(const unsigned maxGapsPerRead, const flowcell::FlowcellLayoutList &flowcellLayoutList):
        recordLength_(getRecordLength(maxGapsPerRead, flowcellLayoutList)),
        readOffsets_(getReadOffsets(maxGapsPerRead, flowcellLayoutList)), // offset of the first read is 0
        clusters_(0)
    {
...
private:
    ...
    static unsigned getRecordLength(const unsigned maxGapsPerRead, const flowcell::FlowcellLayoutList &flowcellLayoutList)
    {
        ...
        return
            io::FragmentHeader::getMaxTotalLength(flowcell::getMaxReadLength(flowcellLayoutList, 0), maxGapsPerRead, clusterNameMax) +
            (read2MaxLength ? (io::FragmentHeader::getMaxTotalLength(read2MaxLength, maxGapsPerRead, clusterNameMax)) : 0);
    }
     ...
     */
    static common::StaticVector<unsigned, 2> getReadOffsets(const unsigned maxGapsPerRead, const flowcell::FlowcellLayoutList &flowcellLayoutList)
    {
        ...
        {
            ret.push_back(io::FragmentHeader::getMaxTotalLength(flowcell::getMaxReadLength(flowcellLayoutList, 0), maxGapsPerRead, clusterNameMax));
        }
        else
        {
