...
public:
    BamSerializer(
        const demultiplexing::BarcodePathMap::BarcodeSampleIndexMap &barcodeOutputFileIndexMap,
...
private:
    ...
    const demultiplexing::BarcodePathMap::BarcodeSampleIndexMap &barcodeOutputFileIndexMap_;
};
