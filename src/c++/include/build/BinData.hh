...
public:
                ...
                splitGapLength, splitInfoList_)
    {
        ...
        static const std::size_t MAX_FRAGMENT_SIZE_EVER = 10240;
        data_.reserve(bin_.getDataSize() + MAX_FRAGMENT_SIZE_EVER * 2);
...
//private:
    ...
    const demultiplexing::BarcodePathMap &barcodeBamMapping_;
    SeIdx seIdx_;
    RIdx rIdx_;
    FIdx fIdx_;
