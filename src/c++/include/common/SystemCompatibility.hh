...
#if defined(_WIN32) && !defined(ISAAC_CYGWIN)

#define iSAAC_THREAD_LOCAL thread_local
#define iSAAC_FILE_THAT_ALWAYS_EXISTS "nul"
#define posix_fadvise(FILE, X, Y, Z) false
#define iSAAC_TSTRING(s) L##s
// 2048 is maximum you can have on win32. And it is not a default
#define iSAAC_SET_MAX_FILES _setmaxstdio(2048)
...
#define iSAAC_THREAD_LOCAL __thread
#define iSAAC_FILE_THAT_ALWAYS_EXISTS "/dev/null"
#define iSAAC_TSTRING(s) s
// nothing to set here. users do it with ulimit
#define iSAAC_SET_MAX_FILES
#define ISAAC_TRACE_STAT(prefix) {\
