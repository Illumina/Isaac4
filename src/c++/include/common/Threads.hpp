...
extern iSAAC_THREAD_LOCAL int runOnNode_;
...
template <typename Ret, typename Run>
static Ret runAsThread(Run run)
{
    runOnNode_ = isaac::common::bindCurrentThreadToNumaNode(0);
