...
void serialize(Archive &ar, BarcodeCounts &bc, const unsigned int version)
{
    ...
    ar & BOOST_SERIALIZATION_NVP(bc.realignableSplits_);
...
void serialize(Archive &ar, BinMetadata &bm, const unsigned int version)
{
    ...
    ar & BOOST_SERIALIZATION_NVP(bm.barcodeBreakdown_);
}
...
template <class Archive>
void serialize(Archive &ar, BarcodePathMap &bbm, const unsigned int version)
{
