...
// For some reason this needs the below abomination on windows, so, just don't have it and explicitly specialize
// with BclBaseCallsSource and BclBgzfBaseCallsSource
//#ifndef _WIN32
//template <>
//#endif
//template <typename BaseCallsSourceT>
...
template <>
struct DataSourceTraits<MultiTileBaseCallsSource<BclBaseCallsSource> > : public DataSourceTraits<BclBaseCallsSource>
{
};

template <>
struct DataSourceTraits<MultiTileBaseCallsSource<BclBgzfBaseCallsSource> > : public DataSourceTraits<BclBgzfBaseCallsSource>
{
};
