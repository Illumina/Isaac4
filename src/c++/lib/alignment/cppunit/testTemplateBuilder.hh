...
////    CPPUNIT_TEST( testEmptyMatchList ); //invalid. match lists must have something
...
private:
    ...
    const isaac::alignment::FragmentMetadata f1_0;
    const isaac::alignment::FragmentMetadata f1_1;
private:
