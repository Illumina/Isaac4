    ...
    ISAAC_XML_WRITER_ELEMENT_BLOCK(xmlWriter, "Stats")
    {
        BOOST_FOREACH(const flowcell::Layout &flowcell, flowcellLayoutList_)
        {
            ...
            ISAAC_XML_WRITER_ELEMENT_BLOCK(xmlWriter, "Flowcell")
            {
                ...
                serializeFlowcellProjects(xmlWriter, flowcell.getLaneIds(), flowcellProjectSampleBarcodeStats[flowcell.getFlowcellId()]);
            }
        }
        ...
        ISAAC_XML_WRITER_ELEMENT_BLOCK(xmlWriter, "Flowcell")
        {
            ...
            serializeFlowcellProjects(xmlWriter, allLanes, flowcellProjectSampleBarcodeStats["all"]);
        }
    }
}
