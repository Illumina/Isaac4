...
isaac::demultiplexing::BarcodePathMap::BarcodeSampleIndexMap emptyMap;
template<>
...
void testNoDifferences(std::vector<IndexT> bin, std::vector<IndexT>  expectedUnique)
{
    ...
    isaac::alignment::BinMetadataCRefList binMetadataCRefList(1, boost::ref(binMetadataList.front()));
