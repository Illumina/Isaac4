...
"  <SoftwareVersion>Isaac-04.16.09.21</SoftwareVersion>"
"  <Contigs>\n"
"    <Contig Position=\"0\">\n"
"      <Index>0</Index>\n"
...
void TestSortedReferenceXml::checkContigs(const isaac::reference::SortedReferenceMetadata &sortedReferenceMetadata)
{
    ...
    CPPUNIT_ASSERT_EQUAL(0UL, sortedReferenceMetadata.getContigs().at(1).genomicPosition_);
    CPPUNIT_ASSERT_EQUAL(1U, sortedReferenceMetadata.getContigs().at(1).index_);
    CPPUNIT_ASSERT_EQUAL(std::string("10"), sortedReferenceMetadata.getContigs().at(1).name_);
    ...
    CPPUNIT_ASSERT_EQUAL(54UL, sortedReferenceMetadata.getContigs().at(1).offset_);
    CPPUNIT_ASSERT_EQUAL(137630983UL, sortedReferenceMetadata.getContigs().at(1).size_);
    CPPUNIT_ASSERT_EQUAL(135374737UL, sortedReferenceMetadata.getContigs().at(1).totalBases_);
    CPPUNIT_ASSERT_EQUAL(131624728UL, sortedReferenceMetadata.getContigs().at(1).acgtBases_);
    CPPUNIT_ASSERT_EQUAL(std::string("Tada"), sortedReferenceMetadata.getContigs().at(1).bamSqAs_);
    CPPUNIT_ASSERT_EQUAL(std::string("/blah"), sortedReferenceMetadata.getContigs().at(1).bamSqUr_);
    CPPUNIT_ASSERT_EQUAL(std::string("12345"), sortedReferenceMetadata.getContigs().at(1).bamM5_);

    CPPUNIT_ASSERT_EQUAL(135374737UL, sortedReferenceMetadata.getContigs().at(0).genomicPosition_);
    CPPUNIT_ASSERT_EQUAL(0U, sortedReferenceMetadata.getContigs().at(0).index_);
    CPPUNIT_ASSERT_EQUAL(std::string("11"), sortedReferenceMetadata.getContigs().at(0).name_);
    ...
    CPPUNIT_ASSERT_EQUAL(137631091UL, sortedReferenceMetadata.getContigs().at(0).offset_);
    CPPUNIT_ASSERT_EQUAL(136693258UL, sortedReferenceMetadata.getContigs().at(0).size_);
    CPPUNIT_ASSERT_EQUAL(134452384UL, sortedReferenceMetadata.getContigs().at(0).totalBases_);
    CPPUNIT_ASSERT_EQUAL(131130753UL, sortedReferenceMetadata.getContigs().at(0).acgtBases_);
    CPPUNIT_ASSERT_EQUAL(std::string(""), sortedReferenceMetadata.getContigs().at(0).bamSqAs_);
    CPPUNIT_ASSERT_EQUAL(std::string(""), sortedReferenceMetadata.getContigs().at(0).bamSqUr_);
    CPPUNIT_ASSERT_EQUAL(std::string("123456"), sortedReferenceMetadata.getContigs().at(0).bamM5_);
}
